...
class FlattenDictToBox(gym.ObservationWrapper):
    ...
    def observation(self, obs):
        ...
        raise TypeError(f"Unsupported observation type: {type(obs)}. Expected dict or array-like.")
...
def main():
    ...
    logger.info(f"Evaluation (20 episodes): mean_reward={mean_reward:.3f} ± {std_reward:.3f}")
